...
export const metadata: Metadata = {
  title: "Reformas en Sax | Reformas Elda Sanchis",
  description:
    "Reformas integrales, de baño y de cocina en Sax, a solo 8 km de nuestra base en Elda. Presupuesto cerrado y visita gratuita. Llama al 865 76 07 05.",
  alternates: { canonical: "/zonas/sax" },
  openGraph: { url: "/zonas/sax" },
};
...
const faqs = [
  {
    q: "¿Trabajáis en viviendas del entorno del Castillo de Sax?",
    a: "Sí. El casco antiguo de Sax se extiende bajo el peñasco donde se levanta su castillo medieval, con calles estrechas y viviendas de trazado irregular. Tenemos experiencia adaptando maquinaria y acopio de materiales a este tipo de accesos, sin que eso afecte al plazo de entrega pactado.",
  },
  {
    q: "¿Cuánto se tarda en desplazarse desde Elda hasta Sax?",
    a: "Sax limita directamente con el norte del término municipal de Elda y está a unos 8 km de nuestra base, apenas 10 minutos en coche. Por eso podemos concertar visitas y dar respuesta a averías o presupuestos con mucha rapidez.",
  },
  {
    q: "¿Reformáis casas con terreno en pendiente, típico de Sax?",
    a: "Sí. Por la orografía del municipio, junto al peñasco del castillo, muchas viviendas de Sax tienen desniveles o plantas semienterradas. Lo valoramos siempre en la visita previa para ajustar el presupuesto a la realidad de cada solar.",
  },
  {
    q: "¿También hacéis reformas fuera del casco urbano de Sax?",
    a: "Sí, atendemos igualmente viviendas en las afueras y en parcelas del término municipal, siempre que el acceso permita el paso de nuestro equipo y materiales. Te lo confirmamos sin compromiso al concertar la visita.",
  },
];

export default function ZonaSaxPage() {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            "@id": "https://reformaseldasanchis.es/zonas/sax#service",
            name: "Reformas en Sax",
            areaServed: "Sax",
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 3, name: "Sax", item: "https://reformaseldasanchis.es/zonas/sax" },
            ],
          }),
        }}
      />
      ...
      <section className="bg-dark text-white py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-white/65 text-lg max-w-2xl mb-8">
            Nuestro equipo, con base en Elda, cubre Sax en pocos minutos. Presupuesto cerrado y visita a domicilio sin coste, también en las viviendas más próximas al castillo.
          </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="relative overflow-hidden aspect-[4/3]">
            <Image
              ...
              alt="Aseo reformado en una vivienda del casco antiguo de Sax"
              fill
              loading="lazy"
              decoding="async"
          ...
          <div>
            <h2 className="font-heading text-2xl md:text-3xl font-bold text-dark mb-5">
              Al pie del castillo, la misma cercanía de siempre
            </h2>
            <p className="text-dark/65 leading-relaxed mb-4">
              Sax limita directamente con el norte del término de Elda, a solo 8 km de nuestra base. Esa cercanía nos permite tratar cada aviso en el municipio con la misma agilidad que si se tratara de una obra en la propia Elda.
            </p>
            <p className="text-dark/65 leading-relaxed mb-4">
              El municipio es conocido por su castillo medieval, levantado sobre un peñasco que domina el valle, y su casco urbano se extiende a los pies de esa formación rocosa, con calles y viviendas que a menudo presentan desniveles importantes.
            </p>
            <p className="text-dark/65 leading-relaxed">
              Adaptamos cada obra a esas particularidades del terreno, siempre partiendo de una visita gratuita y un presupuesto cerrado antes de empezar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-beige">
        <div className="max-w-3xl mx-auto">
          <h2 className="font-heading text-3xl font-bold text-dark text-center mb-10">
            Preguntas frecuentes sobre reformas en Sax
          </h2>
      ...
      <section className="py-12 px-4 bg-accent text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">
            Pide tu presupuesto en Sax
          </h2>
          <p className="text-white/75 mb-8 text-lg">
            Visitamos tu vivienda en Sax sin coste ni compromiso.
          </p>
